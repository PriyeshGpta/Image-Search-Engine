...
const apiKey = "fGI7vLHYS4B3RxTKzNuktWUoW6lmkk2YotkFsfzx4sSYpotUQ9hGfzQw";
const perPage = 15;
let currentPage = 1;
let searchTerm = null;

const downloadImg = (imgURL) => {
    // Converting reveived img to blob, creating its download link and downloading it 
...
downloadImgBtn.addEventListener("click", () => downloadImg(e.target.dataset.img));